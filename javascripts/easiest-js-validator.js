...
var Validator = function Validator(data, rules, messages)
{
...
/**
	 ...
	 */
Validator.make = function make (data, rules, messages)
{
	var validate = new Validator(data, rules, messages);
...
/**
	 ...
	 * @returns {Object}
	 */
Validator.prototype.handle = function handle ()
{
		var this$1 = this;
	...
	for (var rule in this.rules) {
		methods = this$1.rules[rule].split(',');
		this$1.evaluate(methods, rule);
	}
...
/**
	 ...
	 * @returns {Array}
	 */
Validator.prototype.evaluate = function evaluate (methods, field)
{
		var this$1 = this;
	...
	for (var method in methods) {
		...
		if (this$1[methods[method]] && ! this$1[methods[method]](value)) {
			this$1.stackErrors({
				key: field, //evaluated field.
				error: this$1.messages[methods[method]]
			});
		}
	}
};
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.isNotRequired = function isNotRequired (methods, value)
{
...
/**
	 ...
	 * @return {Void}
	 */
Validator.prototype.stackErrors = function stackErrors (data)
{
	if ( ! this.errors.find(function (error) { return error.key == data.key; })) {
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.empty = function empty (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.required = function required (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.numeric = function numeric (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.integer = function integer (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.digits = function digits (value)
{
	return (/^[\d() \.\:\-\+#]+$/).test(value);
};
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.alpha = function alpha (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.alphaNum = function alphaNum (value)
{
	return !(/\W/).test(value);
};
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.email = function email (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.url = function url (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.length = function length (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.blank = function blank (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.dateISO = function dateISO (value)
{
...
/**
	 ...
	 * @return {Boolean}
	 */
Validator.prototype.phone = function phone (value)
{
	/*
	| ----------------------------------------------------------
	| VALID FORMATS
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__validator__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__validator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__validator__);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
	...
	methods:
	{
		...
		submit: function ()
		{
			...
			var validate = __WEBPACK_IMPORTED_MODULE_1__validator___default.a.make(this.profile, this.rules, this.messages);
