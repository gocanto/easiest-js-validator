...
new _vue2.default({
	...
	methods: {
		...
		submit: function submit() {
			...
			var validate = _validator2.default.make(this.profile, this.rules, this.messages);
...
},{"./validator.js":4,"vue":2}],4:[function(require,module,exports){
'use strict';
...
var Validator = function () {
  ...
  */
   ...
   */
		...
		key: 'evaluate',
		value: function evaluate(methods, field) {
   ...
   */
		...
		key: 'stackErrors',
		value: function stackErrors(data) {
			if (!this.errors.find(function (error) {
				return error.key == data.key;
			})) {
   ...
   */
		...
		key: 'make',
		value: function make(data, rules, messages) {
